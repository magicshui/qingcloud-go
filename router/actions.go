...
func DescribeRouters(c *qingcloud.Client, params DescribeRoutersRequest) (DescribeRoutersResponse, error) {
...
func CreateRouters(c *qingcloud.Client, params CreateRoutersRequest) (CreateRoutersResponse, error) {
...
func DeleteRouters(c *qingcloud.Client, params DeleteRoutersRequest) (DeleteRoutersResponse, error) {
...
func UpdateRouters(c *qingcloud.Client, params UpdateRoutersRequest) (UpdateRoutersResponse, error) {
...
func PowerOffRouters(c *qingcloud.Client, params PowerOffRoutersRequest) (PowerOffRoutersResponse, error) {
...
func PowerOnRouters(c *qingcloud.Client, params PowerOnRoutersRequest) (PowerOnRoutersResponse, error) {
...
func JoinRouter(c *qingcloud.Client, params JoinRouterRequest) (JoinRouterResponse, error) {
...
func LeaveRouter(c *qingcloud.Client, params LeaveRouterRequest) (LeaveRouterResponse, error) {
...
func ModifyRouterAttributes(c *qingcloud.Client, params ModifyRouterAttributesRequest) (ModifyRouterAttributesResponse, error) {
...
func DescribeRouterStatics(c *qingcloud.Client, params DescribeRouterStaticsRequest) (DescribeRouterStaticsReponse, error) {
...
type AddRouterStaticsRequest struct {
	Router                  qingcloud.String
	StaticsNRoterStaticName qingcloud.NumberedString
	StaitcsNStaticType      qingcloud.NumberedString
...
func AddRouterStatics(c *qingcloud.Client, params AddRouterStaticsRequest) (AddRouterStaticsResponse, error) {
...
func ModifyRouterStaticAttributes(c *qingcloud.Client, params ModifyRouterStaticAttributesRequest) (ModifyRouterStaticAttributesResponse, error) {
...
func DeleteRouterStatics(c *qingcloud.Client, params DeleteRouterStaticsRequest) (DeleteRouterStaticsResponse, error) {
...
func DescribeRouterVxnets(c *qingcloud.Client, params DescribeRouterVxnetsReqeust) (DescribeRouterVxnetsResponse, error) {
...
func AddRouterStaticEntries(c *qingcloud.Client, params AddRouterStaticEntriesRequest) (AddRouterStaticEntriesResponse, error) {
...
func DeleteRouterStaticEntries(c *qingcloud.Client, params DeleteRouterStaticEntriesReqeust) (DeleteRouterStaticEntriesResponse, error) {
...
func ModifyRouterStaticEntryAttributes(c *qingcloud.Client, params ModifyRouterStaticEntryAttributesReqeust) (ModifyRouterStaticEntryAttributesResponse, error) {
...
func DescribeRouterStaticEntries(c *qingcloud.Client, params DescribeRouterStaticEntriesRequest) (DescribeRouterStaticEntriesResponse, error) {
