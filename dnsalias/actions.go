...
func NewClient(clt *qingcloud.Client) *DNSALIAS {
	return &DNSALIAS{
		Client: clt,
	}
}
...
func (c *DNSALIAS) DescribeDNSAliases(params DescribeDNSAliasesRequest) (DescribeDNSAliasesResponse, error) {
...
func (c *DNSALIAS) AssociateDNSAlias(params AssociateDNSAliasRequest) (AssociateDNSAliasResponse, error) {
...
// 从资源上解绑一个或多个内网域名。
func (c *DNSALIAS) DissociateDNSAliases(params DissociateDNSAliasesRequest) (DissociateDNSAliasesResponse, error) {
...
func (c *DNSALIAS) GetDNSLabel(params GetDNSLabelRequest) (GetDNSLabelResponse, error) {
