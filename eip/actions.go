...
func DescribeEips(c *qingcloud.Client, params DescribeEipsRequest) (DescribeEipsResponse, error) {
...
// 分配后的公网IP可跟主机或路由器绑定。
func AllocateEips(c *qingcloud.Client, params AllocateEipsRequest) (AllocateEipsResponse, error) {
...
func ReleaseEips(c *qingcloud.Client, params ReleaseEipsRequest) (ReleaseEipsResponse, error) {
...
func AssociateEip(c *qingcloud.Client, params AssociateEipRequest) (AssociateEipResponse, error) {
...
func DissociateEips(c *qingcloud.Client, params DissociateEipsRequest) (DissociateEipsResponse, error) {
...
func ChangeEipsBandwidth(c *qingcloud.Client, params ChangeEipsBandwidthRequest) (ChangeEipsBandwidthResponse, error) {
...
func ChangeEipsBillingMode(c *qingcloud.Client, params ChangeEipsBillingModeRequest) (ChangeEipsBillingModeResponse, error) {
...
// 修改时不受公网IP状态限制。
// 一次只能修改一个公网IP。
func ModifyEipAttributes(c *qingcloud.Client, params ModifyEipAttributesRequest) (ModifyEipAttributesResponse, error) {
