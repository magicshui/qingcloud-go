...
func CreateLoadBalancer(c *qingcloud.Client, params CreateLoadBalancerRequest) (CreateLoadBalancerResponse, error) {
...
func DescribeLoadBalancers(c *qingcloud.Client, params DescribeLoadBalancersRequest) (DescribeLoadBalancersResponse, error) {
...
func DeleteLoadBalancers(c *qingcloud.Client, params DeleteLoadBalancersRequest) (DeleteLoadBalancersResponse, error) {
...
// 修改一台负载均衡器的名称和描述。
func ModifyLoadBalancerAttributes(c *qingcloud.Client, params ModifyLoadBalancerAttributesRequest) (ModifyLoadBalancerAttributesResponse, error) {
...
// StartLoadBalancers
// 启动一台或多台负载均衡器。
func StartLoadBalancers(c *qingcloud.Client, params StartLoadBalancersRequest) (StartLoadBalancersResponse, error) {
...
// StopLoadBalancers
// 关闭一台或多台负载均衡器。
func StopLoadBalancers(c *qingcloud.Client, params StopLoadBalancersRequest) (StopLoadBalancersResponse, error) {
...
func UpdateLoadBalancers(c *qingcloud.Client, params UpdateLoadBalancersRequest) (UpdateLoadBalancersResponse, error) {
...
func ResizeLoadBalancers(c *qingcloud.Client, params ResizeLoadBalancersRequest) (ResizeLoadBalancersResponse, error) {
...
func AssociateEipsToLoadBalancer(c *qingcloud.Client, params AssociateEipsToLoadBalancerRequest) (AssociateEipsToLoadBalancerResponse, error) {
...
func DissociateEipsFromLoadBalancer(c *qingcloud.Client, params DissociateEipsFromLoadBalancerRequest) (DissociateEipsFromLoadBalancerResponse, error) {
...
type AddLoadBalancerListenersRequest struct {
	Loadbalancer                  qingcloud.String
	ListenersNListenerPort        qingcloud.NumberedString
	...
	ListenersNForwardfor          qingcloud.NumberedString
...
// 给负载均衡器添加一个或多个监听器。
func AddLoadBalancerListeners(c *qingcloud.Client, params AddLoadBalancerListenersRequest) (AddLoadBalancerListenersResponse, error) {
...
func DescribeLoadBalancerListeners(c *qingcloud.Client, params DescribeLoadBalancerListenersRequest) (DescribeLoadBalancerListenersResponse, error) {
...
// 删除一个或多个负载均衡器监听器。
func DeleteLoadBalancerListeners(c *qingcloud.Client, params DeleteLoadBalancerListenersRequest) (DeleteLoadBalancerListenersResponse, error) {
...
// 修改负载均衡器监听器的属性。
func ModifyLoadBalancerListenerAttributes(c *qingcloud.Client, params ModifyLoadBalancerListenerAttributesRequest) (ModifyLoadBalancerListenerAttributesResponse, error) {
...
type AddLoadBalancerBackendsRequest struct {
	LoadbalancerListener               qingcloud.String
	BackendsNResource_id               qingcloud.NumberedString
	BackendsNLoadbalancer_backend_name qingcloud.NumberedString
	BackendsNLoadbalancer_policy_id    qingcloud.NumberedString
...
func AddLoadBalancerBackends(c *qingcloud.Client, params AddLoadBalancerBackendsRequest) (AddLoadBalancerBackendsResponse, error) {
...
func DescribeLoadBalancerBackends(c *qingcloud.Client, params DescribeLoadBalancerBackendsRequest) (DescribeLoadBalancerBackendsResponse, error) {
...
// 删除一个或多个负载均衡器后端服务。
func DeleteLoadBalancerBackends(c *qingcloud.Client, params DeleteLoadBalancerBackendsRequest) (DeleteLoadBalancerBackendsResponse, error) {
...
// 修改负载均衡器后端服务的属性。
func ModifyLoadBalancerBackendAttributes(c *qingcloud.Client, params ModifyLoadBalancerBackendAttributesRequest) (ModifyLoadBalancerBackendAttributesResponse, error) {
...
func CreateLoadBalancerPolicy(c *qingcloud.Client, params CreateLoadBalancerPolicyRequest) (CreateLoadBalancerPolicyResponse, error) {
...
func DescribeLoadBalancerPolicies(c *qingcloud.Client, params DescribeLoadBalancerPoliciesRequest) (DescribeLoadBalancerPoliciesResponse, error) {
...
// 修改负载均衡器转发策略的属性。
func ModifyLoadBalancerPolicyAttributes(c *qingcloud.Client, params ModifyLoadBalancerPolicyAttributesRequest) (ModifyLoadBalancerPolicyAttributesResponse, error) {
...
func ApplyLoadBalancerPolicy(c *qingcloud.Client, params ApplyLoadBalancerPolicyRequest) (ApplyLoadBalancerPolicyResponse, error) {
...
// 删除一个或多个转发策略。
func DeleteLoadBalancerPolicies(c *qingcloud.Client, params DeleteLoadBalancerPoliciesRequest) (DeleteLoadBalancerPoliciesResponse, error) {
...
func AddLoadBalancerPolicyRules(c *qingcloud.Client, params AddLoadBalancerPolicyRulesRequest) (AddLoadBalancerPolicyRulesResponse, error) {
...
func DescribeLoadBalancerPolicyRules(c *qingcloud.Client, params DescribeLoadBalancerPolicyRulesRequest) (DescribeLoadBalancerPolicyRulesResponse, error) {
...
func ModifyLoadBalancerPolicyRuleAttributes(c *qingcloud.Client, params ModifyLoadBalancerPolicyRuleAttributesRequest) (ModifyLoadBalancerPolicyRuleAttributesResponse, error) {
...
func DeleteLoadBalancerPolicyRules(c *qingcloud.Client, params DeleteLoadBalancerPolicyRulesRequest) (DeleteLoadBalancerPolicyRulesResponse, error) {
...
func CreateServerCertificate(c *qingcloud.Client, params CreateServerCertificateRequest) (CreateServerCertificateResponse, error) {
...
func DescribeServerCertificates(c *qingcloud.Client, params DescribeServerCertificatesRequest) (DescribeServerCertificatesResponse, error) {
...
// 修改一个服务器证书的名称和描述。
func ModifyServerCertificateAttributes(c *qingcloud.Client, params ModifyServerCertificateAttributesRequest) (ModifyServerCertificateAttributesResponse, error) {
...
// 删除一个或多个服务器证书。
func DeleteServerCertificates(c *qingcloud.Client, params DeleteServerCertificatesRequest) (DeleteServerCertificatesResponse, error) {
