...
func DescribeVolumes(c *qingcloud.Client, params DescribeVolumesRequest) (DescribeVolumesResponse, error) {
...
func CreateVolumes(c *qingcloud.Client, params CreateVolumesRequest) (CreateVolumesResponse, error) {
...
func DeleteVolumes(c *qingcloud.Client, params DeleteVolumesRequest) (DeleteVolumesReponse, error) {
...
func AttachVolumes(c *qingcloud.Client, params AttachVolumesRequest) (AttachVolumesResponse, error) {
...
func DetachVolumes(c *qingcloud.Client, params DetachVolumesRequest) (DetachVolumesResponse, error) {
...
// 只允许扩大容量，不支持减小。
func ResizeVolumes(c *qingcloud.Client, params ResizeVolumesRequest) (ResizeVolumesResponse, error) {
...
// 修改时不受硬盘状态限制。
// 一次只能修改一块硬盘。
func ModifyVolumeAttributes(c *qingcloud.Client, params ModifyVolumeAttributesRequest) (ModifyVolumeAttributesResponse, error) {
